...
//	double kd_target = 0.001;
	...
	public boolean moveToPoint(float distance, double theta ,int speed)
	{
...
//			System.out.println(System.currentTimeMillis() - time);
	...
	public double PID(double distance, int speed)
	{
		...
		double offsetL = 1.0;//0.63 - .2;
		double offsetR = 1.0 - .06;//0.57 - .2;
