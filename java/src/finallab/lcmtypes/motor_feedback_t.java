...
public final class motor_feedback_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(finallab.lcmtypes.motor_feedback_t.class))
            return 0L;
 
        classes.add(finallab.lcmtypes.motor_feedback_t.class);
    ...
    public static finallab.lcmtypes.motor_feedback_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        finallab.lcmtypes.motor_feedback_t o = new finallab.lcmtypes.motor_feedback_t();
    ...
    public finallab.lcmtypes.motor_feedback_t copy()
    {
        finallab.lcmtypes.motor_feedback_t outobj = new finallab.lcmtypes.motor_feedback_t();
