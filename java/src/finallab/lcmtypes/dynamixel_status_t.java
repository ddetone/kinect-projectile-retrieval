...
public final class dynamixel_status_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(finallab.lcmtypes.dynamixel_status_t.class))
            return 0L;
 
        classes.add(finallab.lcmtypes.dynamixel_status_t.class);
    ...
    public static finallab.lcmtypes.dynamixel_status_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        finallab.lcmtypes.dynamixel_status_t o = new finallab.lcmtypes.dynamixel_status_t();
    ...
    public finallab.lcmtypes.dynamixel_status_t copy()
    {
        finallab.lcmtypes.dynamixel_status_t outobj = new finallab.lcmtypes.dynamixel_status_t();
