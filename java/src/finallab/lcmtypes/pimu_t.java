...
public final class pimu_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(finallab.lcmtypes.pimu_t.class))
            return 0L;
 
        classes.add(finallab.lcmtypes.pimu_t.class);
    ...
    public static finallab.lcmtypes.pimu_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        finallab.lcmtypes.pimu_t o = new finallab.lcmtypes.pimu_t();
    ...
    public finallab.lcmtypes.pimu_t copy()
    {
        finallab.lcmtypes.pimu_t outobj = new finallab.lcmtypes.pimu_t();
